...
import org.datasource.jdbc.views.retailtransactions.RetailTransactionView;
import org.datasource.jdbc.views.retailtransactions.RetailTransactionViewBuilder;
...
public class RESTViewServiceJDBC {
	...
	@Autowired
	private RetailTransactionViewBuilder retailTransactionViewBuilder;
	...
	@RequestMapping(value = "/customers/CustomerView", method = RequestMethod.GET,
	...
	@RequestMapping(value = "/customers/CustomerViewData", method = RequestMethod.GET,
			produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
	@ResponseBody
	public List<CustomerView> get_CustomerView(
	...
	@RequestMapping(value = "/customers/CustomerDetailsView", method = RequestMethod.GET,
			produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
	@ResponseBody
	...
	@RequestMapping(value = "/customers/CustomerAddressesView", method = RequestMethod.GET,
			produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
	@ResponseBody
	...
	@RequestMapping(value = "/retail/RetailTransactionsView", method = RequestMethod.GET,
			produces = {MediaType.APPLICATION_JSON_VALUE})
	@ResponseBody
	public List<RetailTransactionView> get_RetailTransactionsView() {
		List<RetailTransactionView> viewList = retailTransactionViewBuilder.build().getViewList();
		return viewList;
	}
}